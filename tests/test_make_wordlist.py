...
"""
    ...
    assert entry[0] == "youtuber {noun-forms} :: f=youtuberista; fpl=youtuberistas; pl=youtubers; pl=youtuber"
...
"""
    ...
    assert entry[0] == "youtuber {adj-forms} :: f=youtuberista; fpl=youtuberistas; pl=youtubers; pl=youtuber"
...
"""
    ...
    assert "\n".join(entry)=="""\
cherry {noun-forms} :: pl=cherrys; pl=cherries
